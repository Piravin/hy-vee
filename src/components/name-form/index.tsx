...
const NameForm: React.FC<NameFormProps> = ({ onSubmit }) => {
  ...
  return (
    ...
    >
      ...
      {isSubmitting && (
        <div role="status" className="w-full h-full fixed top-0 left-0 bg-white opacity-70 z-50 flex items-center justify-center">
          <svg
            aria-hidden="true"
            className="w-18 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
            viewBox="0 0 100 101"
            fill="none"
